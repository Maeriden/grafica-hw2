...
features="-DDISABLE_MULTISAMPLING=0 -DDISABLE_MULTITHREADING=0 -DDISABLE_TRANSPARENCY=0"
...
echo "[$(date +%T)] Building raytrace"
g++ -obin/raytrace -std=gnu++14 ${debug_flags} ${profile_flags} ${sse_flags} ${defines} ${features} src/raytrace.cpp ${link_flags}
